...
/****** Object:  StoredProcedure [dbo].[sp_BOH_POSLog_Sync_Roastery_Simphony]    Script Date: 8/21/2018 1:38:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[sp_BOH_POSLog_Sync_Roastery_Simphony] 
...
BEGIN
	...
	select 
		...
		Error_Message
	from dbo.Check_BOH_Pending_Data_Simphony('Y')
